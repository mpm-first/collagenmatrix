parasails.registerPage('users', {
  ...
  methods: {
    ...
    _clearAddUsersModal: function() {
      this.goto('/users');
      // Reset form data.
      this.addUsersFormData = {
        users: [
          {
            fullName: '',
            emailAddress: ''
    ...
    closeAddFriendsModal: function() {
      this._clearAddUsersModal();
    },

    clickAddMoreButton: function() {
      this.addUsersFormData.users.push({
        fullName: '',
        emailAddress: ''
      });
    },

    handleParsingAddUsersForm: function() {
      console.log('can you handle this?');
      // Clear out any pre-existing error messages.
      this.formErrors = {};

      var argins = _.cloneDeep(this.addUsersFormData);
